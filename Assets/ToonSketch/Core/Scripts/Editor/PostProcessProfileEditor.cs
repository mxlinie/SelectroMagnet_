...
namespace ToonSketch
{
    ...
    public class PostProcessProfileEditor : Editor
    {
        ...
        public static readonly string[] OutlineStyleNames = {
            "Disabled",
            "Standard",
            "Sketched (Fixed)",
            "Sketched (Angles)"
        ...
        private static class Styles
        {
            ...
            public static readonly string[] outlineStyleNames = PostProcessProfileEditor.OutlineStyleNames;
        }
        ...
        private void GetHeading(int headingNum)
        {
            switch (headingNum)
            {
                ...
                case 1:
                    EditorUtils.Section(
                        Styles.loFiHeadingText,
                        4
                    );
                    break;
                case 2:
                    EditorUtils.Section(
                        Styles.colorCrushHeadingText,
                        6
                    );
                    break;
                case 3:
                    EditorUtils.Section(
                        Styles.outlineHeadingText,
                        8
                    );
                    break;
                case 4:
                    EditorUtils.Section(
                        Styles.canvasHeadingText,
                        10
                    );
                    break;
                case 5:
                    EditorUtils.Section(
                        Styles.blendHeadingText,
                        10
                    );
                    break;
            }
        ...
        public void OutlineStylePopup()
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                style = (OutlineStyle)EditorGUILayout.Popup(Styles.outlineStyleText, (int)outlineStyle.floatValue, Styles.outlineStyleNames);
            }
            if (EditorGUI.EndChangeCheck())
            {
